...
export interface SimpleZkSessionAccountFactoryInterface
...
export interface SimpleZkSessionAccountFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleZkSessionAccountFactoryInterface;
