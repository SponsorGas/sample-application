...
interface MetaMaskContextData {
  ...
  sdk?: MetaMaskSDK,
  connectMetaMask: (networkId:string) => void,
  clearError: () => void,
...
export const MetaMaskContextProvider = ({ children }: PropsWithChildren) => {
  ...
  const _updateWallet = useCallback(async (providedAccounts?: any) => {
    ...
    console.log(`Setting Wallet ${ chainId}`)
  }, [])
  ...
  const connectMetaMask = async (networkId:string) => {
  ...
  useEffect(() => {
    ...
    const onProviderEvent = async (accounts: string[]) => {
